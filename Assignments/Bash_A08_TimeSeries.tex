...
\KeywordTok{suppressMessages}\NormalTok{(}\KeywordTok{library}\NormalTok{(lubridate))}
\CommentTok{#install.packages("nlme")}
\KeywordTok{suppressMessages}\NormalTok{(}\KeywordTok{library}\NormalTok{(nlme))}
\CommentTok{#install.packages("lsmeans")}
\KeywordTok{suppressMessages}\NormalTok{(}\KeywordTok{library}\NormalTok{(lsmeans))}
\CommentTok{#install.packages("multcompView")}
\KeywordTok{suppressMessages}\NormalTok{(}\KeywordTok{library}\NormalTok{(multcompView))}
\KeywordTok{suppressMessages}\NormalTok{(}\KeywordTok{library}\NormalTok{(trend))}

\NormalTok{PMair <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/EPAair_PM25_NC2018_raw.csv"}\NormalTok{) }
...
\NormalTok{PMair}\OperatorTok{$}\NormalTok{Date <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(PMair}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =} \StringTok{"%m/%d/%y"}\NormalTok{)}
...
\begin{Highlighting}[]
\CommentTok{#a)}
\KeywordTok{ggplot}\NormalTok{(PMair, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Date, }\DataTypeTok{y =}\NormalTok{ Daily.Mean.PM2.}\FloatTok{5.}\NormalTok{Concentration)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{color=}\StringTok{"#7fcdbb"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"Date"}\NormalTok{, }\DataTypeTok{y =} \StringTok{"PM2.5 concentration in 2018"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_x_date}\NormalTok{(}\DataTypeTok{date_breaks =} \StringTok{"30 days"}\NormalTok{, }\DataTypeTok{date_labels =} \StringTok{"%b-%d"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{axis.text.x =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{angle =} \DecValTok{45}\NormalTok{,  }\DataTypeTok{hjust =} \DecValTok{1}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{Bash_A08_TimeSeries_files/figure-latex/unnamed-chunk-2-1.pdf}
...
\begin{Highlighting}[]
\CommentTok{#b)}
\NormalTok{PMair =}\StringTok{ }\NormalTok{PMair[}\KeywordTok{order}\NormalTok{(PMair[,}\StringTok{'Date'}\NormalTok{],}\OperatorTok{-}\NormalTok{PMair[,}\StringTok{'Site.ID'}\NormalTok{]),]}
\NormalTok{PMair =}\StringTok{ }\NormalTok{PMair[}\OperatorTok{!}\KeywordTok{duplicated}\NormalTok{(PMair}\OperatorTok{$}\NormalTok{Date),]}

\CommentTok{#c)}
\NormalTok{PMair.auto <-}\StringTok{ }\KeywordTok{lme}\NormalTok{(}\DataTypeTok{data=}\NormalTok{ PMair, Daily.Mean.PM2.}\FloatTok{5.}\NormalTok{Concentration }\OperatorTok{~}\StringTok{ }\NormalTok{Date, }\DataTypeTok{random =} \OperatorTok{~}\DecValTok{1}\OperatorTok{|}\NormalTok{Site.Name) }
\KeywordTok{summary}\NormalTok{(PMair.auto) }\CommentTok{#intercept = 82.2 and Date= -0.004}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# Splitting dataset by lake}
...
\CommentTok{#Mann-Kendall test for Peter}
\KeywordTok{mk.test}\NormalTok{(Peter.nutrients.surface}\OperatorTok{$}\NormalTok{tn_ug) }\CommentTok{#there is definitely a trend over time (p-value < 0.0001)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#Pettitt test for Peter}
\KeywordTok{pettitt.test}\NormalTok{(Peter.nutrients.surface}\OperatorTok{$}\NormalTok{tn_ug) }\CommentTok{#change point at 36}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#Re-run separate Mann-Kendall for each change point for Peter}
\KeywordTok{mk.test}\NormalTok{(Peter.nutrients.surface}\OperatorTok{$}\NormalTok{tn_ug[}\DecValTok{1}\OperatorTok{:}\DecValTok{36}\NormalTok{]) }\CommentTok{#no change over time for this section}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mk.test}\NormalTok{(Peter.nutrients.surface}\OperatorTok{$}\NormalTok{tn_ug[}\DecValTok{37}\OperatorTok{:}\DecValTok{98}\NormalTok{]) }\CommentTok{#another change point detected within this section because p-value is significant and z-value is positive, run pettitt test again}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#Pettitt test for Peter to detect where second change point is}
\KeywordTok{pettitt.test}\NormalTok{(Peter.nutrients.surface}\OperatorTok{$}\NormalTok{tn_ug[}\DecValTok{37}\OperatorTok{:}\DecValTok{98}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#Another separate Mann-Kendall for each change point section for Peter}
\KeywordTok{mk.test}\NormalTok{(Peter.nutrients.surface}\OperatorTok{$}\NormalTok{tn_ug[}\DecValTok{37}\OperatorTok{:}\DecValTok{57}\NormalTok{]) }\CommentTok{#no change over time for this section}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mk.test}\NormalTok{(Peter.nutrients.surface}\OperatorTok{$}\NormalTok{tn_ug[}\DecValTok{58}\OperatorTok{:}\DecValTok{98}\NormalTok{]) }\CommentTok{#no change over time for this section}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#Mann-Kendall test for Paul}
\KeywordTok{mk.test}\NormalTok{(Paul.nutrients.surface}\OperatorTok{$}\NormalTok{tn_ug) }\CommentTok{#no significant trend over time for Paul lake (p-value = 0.73)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#Pettitt test for Paul}
\KeywordTok{pettitt.test}\NormalTok{(Paul.nutrients.surface}\OperatorTok{$}\NormalTok{tn_ug) }\CommentTok{#change point detected at 16 but result is not significant, as expected (p-value = 0.096)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(PeterPaul.nutrients.surface, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ sampledate, }\DataTypeTok{y =}\NormalTok{ tn_ug, }\DataTypeTok{color =}\NormalTok{ lakename)) }\OperatorTok{+}
...
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x=}\StringTok{"Date"}\NormalTok{, }\DataTypeTok{y=}\StringTok{"Total Nitrogen Concentration"}\NormalTok{, }\DataTypeTok{color=}\StringTok{"Lake"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Bash_A08_TimeSeries_files/figure-latex/unnamed-chunk-7-1.pdf}
